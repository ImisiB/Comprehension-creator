...
while True:
    ...
    if options.lower() == "1":
        answer1 = input("Enter your first number: ")
        answer2 = input("Enter your second number:")
        print(answer1,"+",answer2," = ", str(int(answer1) + int(answer2)))
        print()
        ...
        print("Created by ImisiB")
        quit()
    else:
        print()
        print("Wrong input!, you can type in only; '1', '2', '3','4' or '5'")
        print()